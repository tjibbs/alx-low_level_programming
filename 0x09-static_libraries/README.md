Projects on Static Libraries in C

0. A library is not a luxury but one of the necessities of life  > A static library libmy.a containing all the functions listed below:
int _putchar(char c);
int _islower(int c);
int _isalpha(int c);
int _abs(int n);
